...
module.exports = function (payUUrlsMap, accountData) {
    ...
    transactions.createClient = function (data) {
        ...
        (0, _httpRequest.httpRequest)('POST', payUUrlsMap.recurringPayments + '/rest/v4.9/customers/', {
            headers: {
    ...
    transactions.createPlan = function (data) {
        ...
        var deferred = Q.defer();
        (0, _httpRequest.httpRequest)('POST', payUUrlsMap.recurringPayments + '/rest/v4.9/plans/', {
            headers: {
                'Authorization': 'Basic ' + secureHash
            },
            data: data
    ...
    transactions.createCreditCard = function (clientId, data) {
        var deferred = Q.defer();
        (0, _httpRequest.httpRequest)('POST', payUUrlsMap.recurringPayments + '/rest/v4.9/customers/' + clientId + '/creditCards', {
            headers: {
                'Authorization': 'Basic ' + secureHash
            },
            data: data
    ...
    transactions.createSuscription = function (data) {
        var deferred = Q.defer();
        (0, _httpRequest.httpRequest)('POST', payUUrlsMap.recurringPayments + '/rest/v4.9/subscriptions/', {
            headers: {
                'Authorization': 'Basic ' + secureHash
            },
            data: data
    ...
    transactions.getSuscriptionData = function (subscriptionId) {
        var deferred = Q.defer();
        (0, _httpRequest.httpRequest)('GET', payUUrlsMap.recurringPayments + '/rest/v4.9/subscriptions/' + subscriptionId, {
            headers: {
                'Authorization': 'Basic ' + secureHash
            }
        }).then(function (resp) {
    ...
    transactions.getBills = function (query) {
        ...
        (0, _httpRequest.httpRequest)('GET', payUUrlsMap.recurringPayments + '/rest/v4.9/recurringBill?' + queryUrl, {
            headers: {
                'Authorization': 'Basic ' + secureHash
            }
        }).then(function (resp) {
